...
exports.getAllVirtualMention = exports.getGroupDatas = void 0;
...
var getGroupDatas = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Init_1.app.client.users.list()];
            case 1:
                userList = (_a.sent()).members;
                data = [];
                raw.forEach(function (group) {
                    ...
                    //発火元となるメンションヘッダを生成
                    var mentionArray = (group.virtual_mention.map(function (val) { return "(@".concat(val, ")"); }));
                    var virtualMentionStr = mentionArray.join("|");
                    data.push({
...
var getAllVirtualMention = function () {
    var allVirtualMentions = [];
    raw.forEach(function (group) {
        //発火元となるメンションヘッダを生成
        var mentions = (group.virtual_mention.map(function (val) { return "(@".concat(val, ")"); }));
        allVirtualMentions = allVirtualMentions.concat(mentions);
    });
    return RegExp(allVirtualMentions.join("|"));
};
exports.getAllVirtualMention = getAllVirtualMention;
